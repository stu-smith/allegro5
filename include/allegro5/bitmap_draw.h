...
AL_FUNC(void, al_draw_corner_tinted_scaled_bitmap, (ALLEGRO_BITMAP* bitmap, ALLEGRO_COLOR_CORNERS *tint, float sx, float sy, float sw, float sh, float dx, float dy, float dw, float dh, int flags));
