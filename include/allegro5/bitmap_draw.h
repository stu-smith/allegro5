...
AL_FUNC(void, al_draw_corner_tinted_scaled_bitmap, (ALLEGRO_BITMAP* bitmap, ALLEGRO_COLOR tint_tl, ALLEGRO_COLOR tint_tr, ALLEGRO_COLOR tint_br, ALLEGRO_COLOR tint_bl, float sx, float sy, float sw, float sh, float dx, float dy, float dw, float dh, int flags));
